...
import 'package:sewcode/screens/trackingDetails/trackingDetails.dart';
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        Navigator.pushReplacement(
                          context,
                          PageRouteBuilder(
                            pageBuilder: (_, __, ___) => const newOrders(),
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        //   context,
                        //   PageRouteBuilder(
                        //     pageBuilder: (_, __, ___) => const pending1(),
                        //     transitionDuration: const Duration(seconds: 0),
                        //     transitionsBuilder: (_, b, __, c) =>
                        //         FadeTransition(opacity: b, child: c),
                        //   ),
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const trackingDetails())),
                        child: Container(
                          height: 151.h,
                          width: 351.w,
                          decoration: BoxDecoration(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Image.asset(
                                            'assets/images/QR_code_for_mobile_English_Wikipedia 2.png'),
                                        const Text(
                                          'Edapally',
                                          style: TextStyle(
                                              color: Colors.white,
